    ...
    Container {
        ...
        Container {
            ...
            DropDown {
                ...
                onExpandedChanged: {  
                    if( expanded ){ add.setVisible(false); conta.setMinHeight(950) }
                    else{ add.setVisible(true); conta.setMinHeight(700) }
                }
                
                onSelectedValueChanged: {  yo.gradeChanged = true }
                title: ""
            }
            ...
            DropDown {
                ...
                onSelectedValueChanged: {  yo.creditChanged = true }
            }
            ...
            Divider { translationY: 210.0; preferredWidth: 580; translationX: 58  }
            Divider { translationY: 211.0; preferredWidth: 580; translationX: 58  }
        }
    }
}
